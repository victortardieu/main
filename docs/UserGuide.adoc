...
Format: `add n/TITLE p/PHONE_NUMBER e/AVAIL a/ADDRESS [t/TAG]...`
...
Format: `edit INDEX [n/TITLE] [p/PHONE] [e/AVAIL] [a/ADDRESS] [t/TAG]...`
...
* *Add* `add n/TITLE p/PHONE_NUMBER e/AVAIL a/ADDRESS [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/Available a/123, Clementi Rd, 1234665 t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/TITLE] [p/PHONE_NUMBER] [e/AVAIL] [a/ADDRESS] [t/TAG]...` +
