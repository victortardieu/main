...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Book expectedBook = new BookBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
        ...
        Book expectedBookMultipleTags = new BookBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Book expectedBook = new BookBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
