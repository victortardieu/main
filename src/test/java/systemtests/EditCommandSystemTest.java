...
public class EditCommandSystemTest extends CatalogueSystemTest {
    ...
    public void edit() throws Exception {
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + TITLE_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
        ...
        index = INDEX_FIRST_BOOK;
        selectBook(index);
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + TITLE_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
