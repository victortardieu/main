...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB
                + AVAIL_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedBook));

        // multiple names - last name accepted
        assertParseSuccess(parser, TITLE_DESC_AMY + TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB
                + AVAIL_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedBook));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB
                + AVAIL_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedBook));

        // multiple avail - last avail accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_AMY
                + AVAIL_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedBook));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + AUTHOR_DESC_AMY
                + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedBook));
        ...
        assertParseSuccess(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Book expectedBook = new BookBuilder().withTitle(VALID_TITLE_AMY)
                ...
                .withTags().build();
        assertParseSuccess(parser, TITLE_DESC_AMY + AUTHOR_DESC_AMY + PHONE_DESC_AMY + AVAIL_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_TITLE_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + VALID_PHONE_BOB + AVAIL_DESC_BOB,
                expectedMessage);

        // missing avail prefix
        assertParseFailure(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + VALID_AVAIL_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, TITLE_DESC_BOB + VALID_AUTHOR_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_TITLE_BOB + VALID_AUTHOR_BOB + VALID_PHONE_BOB + VALID_AVAIL_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_TITLE_DESC + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Title.MESSAGE_TITLE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + INVALID_PHONE_DESC + AVAIL_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_PHONE_CONSTRAINTS);

        // invalid avail
        assertParseFailure(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + INVALID_AVAIL_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Avail.MESSAGE_AVAIL_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, TITLE_DESC_BOB + INVALID_AUTHOR_DESC + PHONE_DESC_BOB + AVAIL_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Author.MESSAGE_AUTHOR_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, TITLE_DESC_BOB + AUTHOR_DESC_BOB + PHONE_DESC_BOB + AVAIL_DESC_BOB
                + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_TITLE_DESC + INVALID_AUTHOR_DESC + PHONE_DESC_BOB + AVAIL_DESC_BOB,
                Title.MESSAGE_TITLE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + TITLE_DESC_BOB + AVAIL_DESC_BOB
                        + AUTHOR_DESC_BOB + PHONE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
