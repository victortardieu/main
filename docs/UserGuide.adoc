...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact titled `John Doe` to the Catalogue.
...
* Parameters can be in any order e.g. if the command specifies `n/TITLE p/PHONE_NUMBER`, `p/PHONE_NUMBER n/TITLE` is also acceptable.
====
...
Format: `add n/TITLE p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
...
Edits the phone number and email address of the 1st book to be `91234567` and `johndoe@example.com` respectively.
...
* *Add* `add n/TITLE p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/TITLE] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
